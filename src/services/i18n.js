...
const STRINGS = {
  en: {
    ...
    "handler.component_error": "Something went wrong with that. Try again in a moment.",
    "handler.click_fast": "You're clicking a bit fast. Try again in a second.",
    "greeter.welcome_default": "Hi {user}, welcome to {server}! Make yourself at home.",
    "greeter.leave_default": "Bye, {user} — see you again in {server}!",
    "levels.levelup_default": "{user} reached level **{level}**!",
    "birthday.default": "🎂 Happy birthday, {user}! Have a great day!",
    "afk.welcome_back": "Welcome back, {user}! You're no longer AFK (away since {since}).",
    "afk.is_afk": "{user} is AFK ({since}): {reason}",
    "perm.owner_only": "Only the bot owner can use this command.",
    ...
    "perm.unresolved": "I couldn't check your permissions here.",
    "confirm.title": "Are you sure?",
    "confirm.yes": "Confirm",
    "confirm.no": "Cancel",
    "confirm.cancelled": "Cancelled — nothing was changed.",
    "confirm.timeout": "That took too long — nothing was changed.",
  },
  id: {
    ...
    "handler.component_error": "Ada yang salah barusan. Coba lagi sebentar lagi.",
    ...
    "afk.welcome_back": "Selamat datang kembali, {user}! Kamu sudah tidak AFK lagi (AFK sejak {since}).",
    ...
    "perm.unresolved": "Aku tidak bisa mengecek permission-mu di sini.",
    "confirm.title": "Yakin?",
    "confirm.yes": "Lanjutkan",
    "confirm.no": "Batal",
    "confirm.cancelled": "Dibatalkan — tidak ada yang berubah.",
    "confirm.timeout": "Kelamaan — tidak ada yang berubah.",
  },
};
