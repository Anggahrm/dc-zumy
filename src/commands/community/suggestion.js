...
registerStrings("suggestion", {
  ...
  id: {
    ...
    card_update_failed: "- Catatan: aku tidak bisa memperbarui postingan aslinya (mungkin sudah dihapus).",
  },
});
