...
registerStrings("giveaway", {
  en: {
    ...
    reason_not_found: "Couldn't find giveaway #{id} in this server.",
    ...
    process_failed: "Something went wrong with that giveaway. Try again.",
    ended_winners: "Giveaway **#{id}** ended — winner(s): {winners}",
    rerolled_winners: "Giveaway **#{id}** rerolled — winner(s): {winners}",
    ended_no_entries: "Giveaway **#{id}** ended — nobody joined.",
    rerolled_no_entries: "Giveaway **#{id}** rerolled — nobody joined.",
    list_empty: "No giveaways yet. Start one with `/giveaway start`.",
    list_line_running: "**#{id}** {prize} — {entrants} joined, ends <t:{timestamp}:R>",
    list_line_ended: "**#{id}** {prize} — {entrants} joined, ended <t:{timestamp}:R>",
    list_title: "Giveaways",
  },
  id: {
    title: "Giveaway",
    entry_ended: "Giveaway ini sudah berakhir.",
    entered: "Kamu ikut! Semoga beruntung ya.",
    ...
    reason_not_found: "Giveaway #{id} tidak ketemu di server ini.",
    ...
    process_failed: "Ada yang salah dengan giveaway itu. Coba lagi ya.",
    ended_winners: "Giveaway **#{id}** berakhir — pemenang: {winners}",
    rerolled_winners: "Giveaway **#{id}** di-reroll — pemenang: {winners}",
    ended_no_entries: "Giveaway **#{id}** selesai — belum ada yang ikut.",
    rerolled_no_entries: "Giveaway **#{id}** di-reroll — belum ada yang ikut.",
...
export default {
  ...
  data: new SlashCommandBuilder()
    .setName("giveaway")
    .setDescription("Run giveaways members join with a button")
