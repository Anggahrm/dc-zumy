...
registerStrings("shop", {
  en: {
    ...
    bought_line: "You bought <@&{role}> for **{price}** 💰",
    balance_line: "- Balance: **{balance}**",
    need_manage_server: "You need **Manage Server** to manage the shop.",
    cannot_sell: "That role can't be sold — it's managed, @everyone, or above my highest role.",
  ...
  id: {
    ...
    bought_line: "Kamu membeli <@&{role}> seharga **{price}** 💰",
    balance_line: "- Saldo: **{balance}**",
    need_manage_server: "Kamu butuh **Manage Server** untuk mengelola toko.",
    cannot_sell: "Role itu tidak bisa dijual — role-nya managed, @everyone, atau di atas role tertinggiku.",
