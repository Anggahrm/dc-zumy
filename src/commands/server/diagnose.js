...
registerStrings("diagnose", {
  en: {
    ...
    no_member_object: "I couldn't check my own member info — try again in a moment.",
    ...
    roles_header: "**Roles**",
    line_unset: "- {label}: not set yet",
    channel_missing: "❌ {label}: that channel no longer exists — {hint}",
    channel_no_send: "❌ {label}: I can't send messages in <#{channel_id}>",
    channel_ok: "✅ {label}: <#{channel_id}>",
    role_missing: "❌ {label}: that role no longer exists — {hint}",
    ...
    autorole_ok: "✅ Autorole: all {count} role(s) can be given out",
    autorole_broken: "❌ Autorole: {count} role(s) I can't give out — fix with `/autorole remove`",
    rewards_ok: "✅ Level rewards: all {count} role(s) can be given out",
  ...
  id: {
    ...
    no_member_object: "Aku tidak bisa membaca data member-ku sendiri — coba lagi sebentar lagi.",
    ...
    roles_header: "**Role**",
    line_unset: "- {label}: belum diatur",
    channel_missing: "❌ {label}: channel-nya sudah tidak ada — {hint}",
    channel_no_send: "❌ {label}: aku tidak bisa kirim pesan di <#{channel_id}>",
    channel_ok: "✅ {label}: <#{channel_id}>",
    role_missing: "❌ {label}: role-nya sudah tidak ada — {hint}",
    ...
    autorole_ok: "✅ Autorole: semua {count} role bisa kuberikan",
    autorole_broken: "❌ Autorole: {count} role tidak bisa kuberikan — perbaiki dengan `/autorole remove`",
...
export default {
  ...
  data: new SlashCommandBuilder()
    .setName("diagnose")
    .setDescription("Check the bot's permissions and feature setup for problems")
