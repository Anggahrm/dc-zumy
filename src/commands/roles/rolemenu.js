...
registerStrings("rolemenu", {
  en: {
    ...
    membership_unresolved: "I couldn't look up your member info — try again in a moment.",
  ...
  id: {
    ...
    membership_unresolved: "Aku tidak bisa membaca data member-mu — coba lagi sebentar lagi.",
