...
registerStrings("softban", {
  en: {
    title: "Moderation",
    only_in_server: "I can only softban people who are still in this server.",
    cannot_softban_hierarchy: "I can't softban them — their role is above mine, or I'm missing permissions.",
    dm_action_label: "Softban",
    dm_rejoin_line: "- You can join again with a new invite.",
    softban_failed: "The softban didn't go through. Check that my role is above theirs and that I can ban members.",
    ...
    purged_line: "- Messages deleted: **{days}** day(s)",
  ...
  id: {
    ...
    cannot_softban_hierarchy: "Aku tidak bisa softban member itu — role mereka di atas role-ku, atau permission-ku kurang.",
    dm_action_label: "Softban",
    dm_rejoin_line: "- Kamu bisa join lagi lewat invite baru.",
    softban_failed: "Softban-nya tidak berhasil. Pastikan role-ku di atas role member itu dan aku punya izin ban ya.",
    case_suffix: " — Case #{caseNumber}",
    complete_title: "**Softban Selesai**{caseSuffix}",
    target_line: "- Target: **{user}** (`{id}`)",
    moderator_line: "- Moderator: **{moderator}**",
    purged_line: "- Pesan dihapus: **{days}** hari",
