...
registerStrings("massban", {
  en: {
    ...
    count_range: "Give me 1 to {max} user IDs at a time.",
    skip_protected: "protected",
    skip_hierarchy: "role too high",
    skip_not_bannable: "can't be banned",
    skip_api_error: "Discord error",
  ...
  id: {
    title: "Massban",
    invalid_ids: "Sepertinya ini bukan user ID: {ids}",
    count_range: "Masukkan 1 sampai {max} user ID sekali jalan ya.",
    skip_protected: "dilindungi",
    skip_hierarchy: "role lebih tinggi",
    skip_not_bannable: "tidak bisa di-ban",
    skip_api_error: "error dari Discord",
    case_suffix: " — Case #{caseNumber}",
