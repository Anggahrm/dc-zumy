...
registerStrings("kick", {
  en: {
    ...
    only_in_server: "I can only kick people who are still in this server.",
    cannot_kick_self: "You can't kick yourself.",
    cannot_kick_owner: "You can't kick the server owner.",
    cannot_kick_higher_role: "You can't kick someone with a role equal to or higher than yours.",
    cannot_kick_hierarchy: "I can't kick them — their role is above mine, or I'm missing permissions.",
    kick_failed: "The kick didn't go through. Check that my role is above theirs and that I can kick members.",
  ...
  id: {
    ...
    cannot_kick_hierarchy: "Aku tidak bisa kick member itu — role mereka di atas role-ku, atau permission-ku kurang.",
    kick_failed: "Kick-nya tidak berhasil. Pastikan role-ku di atas role member itu dan aku punya izin kick ya.",
    dm_action_label: "Kick",
