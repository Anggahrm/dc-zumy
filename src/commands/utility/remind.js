...
registerStrings("remind", {
  en: {
    ...
    delivered_channel: "-# I'll send it in this channel (or DM you if I can't).",
    delivered_dm: "-# I'll send it to you in a DM.",
    list_empty: "No reminders set. Use `/remind set`.",
    list_title: "Your reminders",
    cancelled: "Reminder **#{id}** cancelled.",
    cancel_not_found: "Couldn't find that reminder — it may have already been sent.",
  },
  id: {
    title: "Pengingat",
    ...
    delivered_channel: "-# Aku kirim di channel ini (atau lewat DM kalau tidak bisa).",
    delivered_dm: "-# Aku kirim lewat DM ya.",
    list_empty: "Belum ada pengingat. Pakai `/remind set`.",
    list_title: "Pengingatmu",
    cancelled: "Pengingat **#{id}** dibatalkan.",
    cancel_not_found: "Pengingat itu tidak ketemu — mungkin sudah terkirim.",
  },
});
